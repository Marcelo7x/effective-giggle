...
void part_ordena2(int num_disp, int cap_memoria){
    ...
    //for(int k = 0; k < cap_memoria; k++){
        ...
        for (int i = 0; i < cap_memoria; i++)
        {
            ...
            {
                //cout << "disp1 = ";
                //imprimeChaves(disp1, cap_memoria);
                ...
                //for(int j = 0; j < cap_memoria; j++){
                    sprintf(disp, "disp%d.txt", num_disp2);
